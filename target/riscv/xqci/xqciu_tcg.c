...
TCGv_i32 temp20 = xqci_csrr(ctx, env, 1993);
TCGv_i32 temp16 = tcg_temp_new_i32();
tcg_gen_andi_i32(temp16, temp20, -1425076225);
TCGv_i32 temp0 = tcg_temp_new_i32();
tcg_gen_shri_i32(temp0, temp20, 28);
...
tcg_gen_ori_i32(temp0, temp16, 268435456);
tcg_gen_shli_i32(temp16, temp14, 26);
tcg_gen_or_i32(temp0, temp16, temp0);
tcg_gen_shri_i32(temp14, temp20, 8);
tcg_gen_andi_i32(temp16, temp14, 61440);
tcg_gen_or_i32(temp16, temp0, temp16);
tcg_gen_ori_i32(temp0, temp16, 1089470464);
xqci_csrw(ctx, env, 1993, temp0);
temp16 = xqci_csrr(ctx, env, 1860);
TCGLabel * label27 = gen_new_label();
TCGLabel * label28 = gen_new_label();
tcg_gen_brcondi_i32(TCG_COND_EQ, temp16, 0, label27);
gen_set_label(label28);
temp14 = xqci_csrr(ctx, env, 1860);
TCGLabel * label29 = gen_new_label();
TCGLabel * label30 = gen_new_label();
tcg_gen_brcondi_i32(TCG_COND_EQ, temp14, 1, label29);
gen_set_label(label30);
TCGv_i32 temp12 = xqci_csrr(ctx, env, 1860);
TCGLabel * label31 = gen_new_label();
TCGLabel * label32 = gen_new_label();
tcg_gen_brcondi_i32(TCG_COND_NE, temp12, 3, label31);
...
TCGv_i32 temp20 = xqci_csrr(ctx, env, 1993);
TCGv_i32 temp14 = tcg_temp_new_i32();
tcg_gen_andi_i32(temp14, temp20, -739241985);
TCGv_i32 temp0 = tcg_temp_new_i32();
tcg_gen_shri_i32(temp0, temp20, 27);
TCGv_i32 temp12 = tcg_temp_new_i32();
tcg_gen_andi_i32(temp12, temp0, 1);
TCGv_i32 temp16 = tcg_temp_new_i32();
tcg_gen_shri_i32(temp16, temp20, 29);
tcg_gen_andi_i32(temp0, temp16, 1);
xqci_csrw_field(ctx, env, 768, 8, temp12);
xqci_csrw_field(ctx, env, 768, 128, tcg_constant_i32(1));
xqci_csrw_field(ctx, env, 784, 1024, temp0);
tcg_gen_ori_i32(temp16, temp14, 134217728);
tcg_gen_shli_i32(temp14, temp12, 26);
tcg_gen_or_i32(temp16, temp14, temp16);
tcg_gen_shri_i32(temp12, temp20, 4);
tcg_gen_andi_i32(temp14, temp12, 61440);
tcg_gen_or_i32(temp14, temp16, temp14);
tcg_gen_ori_i32(temp16, temp14, 983040);
xqci_csrw(ctx, env, 1993, temp16);
TCGLabel * label31 = gen_new_label();
TCGLabel * label32 = gen_new_label();
tcg_gen_brcondi_i32(TCG_COND_NE, temp0, 0, label31);
gen_set_label(label32);
temp16 = xqci_csrr(ctx, env, 768);
TCGLabel * label33 = gen_new_label();
TCGLabel * label34 = gen_new_label();
tcg_gen_brcondi_i32(TCG_COND_EQ, temp16, 0, label33);
gen_set_label(label34);
temp14 = xqci_csrr(ctx, env, 768);
TCGLabel * label35 = gen_new_label();
TCGLabel * label36 = gen_new_label();
tcg_gen_brcondi_i32(TCG_COND_EQ, temp14, 1, label35);
gen_set_label(label36);
temp12 = xqci_csrr(ctx, env, 768);
TCGLabel * label37 = gen_new_label();
TCGLabel * label38 = gen_new_label();
tcg_gen_brcondi_i32(TCG_COND_NE, temp12, 3, label37);
...
static void emit_qc_ext(DisasContext *ctx, TCGv_env env, int8_t vi_11, int8_t vi_18, int8_t vi_21, int8_t vi_4) {
...
static void emit_qc_extd(DisasContext *ctx, TCGv_env env, int8_t vi_11, int8_t vi_16, int8_t vi_23, int8_t vi_4) {
...
static void emit_qc_extdpr(DisasContext *ctx, TCGv_env env, int8_t vi_22, int8_t vi_26, int8_t vi_4) {
TCGv_i32 temp0 = tcg_temp_new_i32();
xqci_get_gpr(ctx, (vi_26 + 1));
TCGv_i32 temp12 = xqci_get_gpr(ctx, vi_26);
TCGv_i32 temp20 = xqci_get_gpr(ctx, vi_22);
TCGv_i32 temp13 = tcg_temp_new_i32();
tcg_gen_shri_i32(temp13, temp20, 8);
TCGv_i32 temp7 = tcg_temp_new_i32();
tcg_gen_andi_i32(temp7, temp13, 63);
TCGv_i32 temp9 = tcg_temp_new_i32();
tcg_gen_umin_i32(temp9, temp7, tcg_constant_i32(32));
temp13 = xqci_get_gpr(ctx, vi_22);
tcg_gen_movi_i32(temp0, 0);
TCGLabel * label30 = gen_new_label();
TCGLabel * label31 = gen_new_label();
tcg_gen_brcondi_i32(TCG_COND_EQ, temp9, 0, label30);
gen_set_label(label31);
TCGv_i32 temp6 = tcg_temp_new_i32();
tcg_gen_andi_i32(temp6, temp13, 31);
...
static void emit_qc_extdprh(DisasContext *ctx, TCGv_env env, int8_t vi_23, int8_t vi_27, int8_t vi_4) {
TCGv_i32 temp0 = tcg_temp_new_i32();
xqci_get_gpr(ctx, (vi_27 + 1));
TCGv_i32 temp12 = xqci_get_gpr(ctx, vi_27);
TCGv_i32 temp21 = xqci_get_gpr(ctx, vi_23);
TCGv_i32 temp14 = tcg_temp_new_i32();
tcg_gen_shri_i32(temp14, temp21, 24);
TCGv_i32 temp6 = tcg_temp_new_i32();
tcg_gen_andi_i32(temp6, temp14, 63);
TCGv_i32 temp9 = tcg_temp_new_i32();
tcg_gen_umin_i32(temp9, temp6, tcg_constant_i32(32));
temp14 = xqci_get_gpr(ctx, vi_23);
tcg_gen_movi_i32(temp0, 0);
TCGLabel * label31 = gen_new_label();
TCGLabel * label32 = gen_new_label();
tcg_gen_brcondi_i32(TCG_COND_EQ, temp9, 0, label31);
gen_set_label(label32);
TCGv_i32 temp7 = tcg_temp_new_i32();
tcg_gen_shri_i32(temp7, temp14, 16);
...
static void emit_qc_extdr(DisasContext *ctx, TCGv_env env, int8_t vi_22, int8_t vi_26, int8_t vi_4) {
TCGv_i32 temp0 = tcg_temp_new_i32();
xqci_get_gpr(ctx, (vi_26 + 1));
TCGv_i32 temp12 = xqci_get_gpr(ctx, vi_26);
TCGv_i32 temp20 = xqci_get_gpr(ctx, vi_22);
TCGv_i32 temp13 = tcg_temp_new_i32();
tcg_gen_shri_i32(temp13, temp20, 16);
TCGv_i32 temp7 = tcg_temp_new_i32();
tcg_gen_andi_i32(temp7, temp13, 63);
TCGv_i32 temp9 = tcg_temp_new_i32();
tcg_gen_umin_i32(temp9, temp7, tcg_constant_i32(32));
...
gen_set_label(label30);
TCGv_i32 temp7 = tcg_temp_new_i32();
tcg_gen_andi_i32(temp7, temp12, 31);
...
static void emit_qc_extduprh(DisasContext *ctx, TCGv_env env, int8_t vi_22, int8_t vi_26, int8_t vi_4) {
TCGv_i32 temp0 = tcg_temp_new_i32();
xqci_get_gpr(ctx, (vi_26 + 1));
TCGv_i32 temp11 = xqci_get_gpr(ctx, vi_26);
TCGv_i32 temp20 = xqci_get_gpr(ctx, vi_22);
TCGv_i32 temp13 = tcg_temp_new_i32();
tcg_gen_shri_i32(temp13, temp20, 24);
TCGv_i32 temp7 = tcg_temp_new_i32();
tcg_gen_andi_i32(temp7, temp13, 63);
TCGv_i32 temp10 = tcg_temp_new_i32();
...
TCGLabel * label30 = gen_new_label();
TCGLabel * label31 = gen_new_label();
tcg_gen_brcondi_i32(TCG_COND_EQ, temp10, 0, label30);
gen_set_label(label31);
TCGv_i32 temp6 = tcg_temp_new_i32();
...
static void emit_qc_extdur(DisasContext *ctx, TCGv_env env, int8_t vi_21, int8_t vi_25, int8_t vi_4) {
TCGv_i32 temp0 = tcg_temp_new_i32();
xqci_get_gpr(ctx, (vi_25 + 1));
TCGv_i32 temp11 = xqci_get_gpr(ctx, vi_25);
TCGv_i32 temp19 = xqci_get_gpr(ctx, vi_21);
TCGv_i32 temp12 = tcg_temp_new_i32();
tcg_gen_shri_i32(temp12, temp19, 16);
TCGv_i32 temp6 = tcg_temp_new_i32();
tcg_gen_andi_i32(temp6, temp12, 63);
TCGv_i32 temp10 = tcg_temp_new_i32();
tcg_gen_umin_i32(temp10, temp6, tcg_constant_i32(32));
...
static void emit_qc_lieq(DisasContext *ctx, TCGv_env env, int8_t vi_16, int8_t vi_13, int8_t vi_6, int8_t vi_4) {
