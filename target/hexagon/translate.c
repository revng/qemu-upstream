...
intptr_t get_new_temp_vector_offset(unsigned index) {
  assert(index < STRUCT_ARRAY_SIZE(CPUHexagonState, VTempRegs));
  return offsetof(CPUHexagonState, VTempRegs) + index * structsizeof(CPUHexagonState, VTempRegs[0]);
}
