...
static inline void gen_sat_i32(TCGv dest,
                               TCGv source,
                               int width,
                               bool set_overflow) {
...
static inline void gen_satu_i32(TCGv dest,
                                TCGv source,
                                int width,
                                bool set_overflow) {
...
static inline void gen_sat_i64(TCGv_i64 dest,
                               TCGv_i64 source,
                               int width,
                               bool set_overflow) {
...
static inline void gen_satu_i64(TCGv_i64 dest,
                                TCGv_i64 source,
                                int width,
                                bool set_overflow) {
